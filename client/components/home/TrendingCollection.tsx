...
const TrendingCollection = () => {
  ...
  const categories = ["Shirt", "T-Shirt", "Trousers", "Shorts", "Cargo Pants"];
  const loading = isFetchingBottoms || isFetchingTop;
  const [filteredCollection, setFilteredCollection] = useState(trending);
  const [selectedType, setSelectedType] = useState("Cargo Pants");
  ...
  if (loading) return <TrendingCollectionSkeleton />;
  return (
